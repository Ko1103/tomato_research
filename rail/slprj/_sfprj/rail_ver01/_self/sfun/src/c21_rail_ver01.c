...
static void initialize_c21_rail_ver01(SFc21_rail_ver01InstanceStruct
  *chartInstance);
static void initialize_params_c21_rail_ver01(SFc21_rail_ver01InstanceStruct
  *chartInstance);
static void enable_c21_rail_ver01(SFc21_rail_ver01InstanceStruct *chartInstance);
static void disable_c21_rail_ver01(SFc21_rail_ver01InstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_rail_ver01
  (SFc21_rail_ver01InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_rail_ver01
  (SFc21_rail_ver01InstanceStruct *chartInstance);
static void set_sim_state_c21_rail_ver01(SFc21_rail_ver01InstanceStruct
  *chartInstance, const mxArray *c21_st);
static void finalize_c21_rail_ver01(SFc21_rail_ver01InstanceStruct
  *chartInstance);
static void sf_gateway_c21_rail_ver01(SFc21_rail_ver01InstanceStruct
  *chartInstance);
static void mdl_start_c21_rail_ver01(SFc21_rail_ver01InstanceStruct
  *chartInstance);
static void c21_chartstep_c21_rail_ver01(SFc21_rail_ver01InstanceStruct
  *chartInstance);
static void initSimStructsc21_rail_ver01(SFc21_rail_ver01InstanceStruct
  *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static void c21_emlrt_marshallIn(SFc21_rail_ver01InstanceStruct *chartInstance,
  const mxArray *c21_d_u, const emlrtMsgIdentifier *c21_parentId, real_T
  c21_c_y[651264]);
...
static const mxArray *c21_b_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_b_emlrt_marshallIn(SFc21_rail_ver01InstanceStruct
...
static const mxArray *c21_c_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static void c21_c_emlrt_marshallIn(SFc21_rail_ver01InstanceStruct *chartInstance,
  const mxArray *c21_b_sliderBW, const char_T *c21_identifier, boolean_T
  c21_c_y[217088]);
static void c21_d_emlrt_marshallIn(SFc21_rail_ver01InstanceStruct *chartInstance,
  const mxArray *c21_d_u, const emlrtMsgIdentifier *c21_parentId, boolean_T
  c21_c_y[217088]);
...
static const mxArray *c21_f_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_e_emlrt_marshallIn(SFc21_rail_ver01InstanceStruct
  *chartInstance, const mxArray *c21_d_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_f_emlrt_marshallIn(SFc21_rail_ver01InstanceStruct
  *chartInstance, const mxArray *c21_b_is_active_c21_rail_ver01, const char_T
  *c21_identifier);
static uint8_T c21_g_emlrt_marshallIn(SFc21_rail_ver01InstanceStruct
  *chartInstance, const mxArray *c21_d_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_rail_ver01InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc21_rail_ver01InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc21_rail_ver01(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c21_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c21_is_active_c21_rail_ver01 = 0U;
}
  ...
  (SFc21_rail_ver01InstanceStruct *chartInstance)
{
  ...
  c21_hoistedGlobal = chartInstance->c21_is_active_c21_rail_ver01;
  c21_e_y = NULL;
  ...
  *chartInstance, const mxArray *c21_st)
{
  ...
  c21_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c21_d_u, 0)),
    "BW", chartInstance->c21_bv0);
  for (c21_i0 = 0; c21_i0 < 217088; c21_i0++) {
    (*chartInstance->c21_b_BW)[c21_i0] = chartInstance->c21_bv0[c21_i0];
  }

  chartInstance->c21_is_active_c21_rail_ver01 = c21_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_d_u, 1)),
     "is_active_c21_rail_ver01");
  sf_mex_destroy(&c21_d_u);
  c21_update_debugger_state_c21_rail_ver01(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c21_i1 = 0; c21_i1 < 6; c21_i1++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c21_value)[c21_i1], 1U);
  }

  for (c21_i2 = 0; c21_i2 < 651264; c21_i2++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c21_b_RGB)[c21_i2], 0U);
  }

  chartInstance->c21_sfEvent = CALL_EVENT;
  c21_chartstep_c21_rail_ver01(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  for (c21_i3 = 0; c21_i3 < 217088; c21_i3++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c21_b_BW)[c21_i3], 2U);
  }
}
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c21_nargin, 8U, c21_b_sf_marshallOut,
    c21_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c21_nargout, 9U, c21_b_sf_marshallOut,
    c21_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(chartInstance->c21_RGB, 10U, c21_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c21_b_value, 11U, c21_e_sf_marshallOut);
  ...
  rgb2hsv_tbb_uint8(chartInstance->c21_X, 217088.0, chartInstance->c21_I, true);
  ...
  *c21_inData)
{
  ...
  int32_T c21_i38;
  SFc21_rail_ver01InstanceStruct *chartInstance;
  chartInstance = (SFc21_rail_ver01InstanceStruct *)chartInstanceVoid;
  c21_mxArrayOutData = NULL;
  c21_mxArrayOutData = NULL;
  c21_i34 = 0;
  for (c21_i35 = 0; c21_i35 < 3; c21_i35++) {
    c21_i36 = 0;
    for (c21_i37 = 0; c21_i37 < 512; c21_i37++) {
      for (c21_i38 = 0; c21_i38 < 424; c21_i38++) {
        chartInstance->c21_u[(c21_i38 + c21_i36) + c21_i34] = (*(real_T (*)
          [651264])c21_inData)[(c21_i38 + c21_i36) + c21_i34];
      }
  ...
  c21_c_y[651264])
{
  ...
  sf_mex_import(c21_parentId, sf_mex_dup(c21_d_u), chartInstance->c21_dv0, 1, 0,
                0U, 1, 0U, 3, 424, 512, 3);
  for (c21_i39 = 0; c21_i39 < 651264; c21_i39++) {
    c21_c_y[c21_i39] = chartInstance->c21_dv0[c21_i39];
  }
  ...
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData)
{
  ...
  c21_emlrt_marshallIn(chartInstance, sf_mex_dup(c21_b_I), &c21_thisId,
                       chartInstance->c21_y);
  sf_mex_destroy(&c21_b_I);
  c21_i40 = 0;
  for (c21_i41 = 0; c21_i41 < 3; c21_i41++) {
    c21_i42 = 0;
    for (c21_i43 = 0; c21_i43 < 512; c21_i43++) {
      for (c21_i44 = 0; c21_i44 < 424; c21_i44++) {
        (*(real_T (*)[651264])c21_outData)[(c21_i44 + c21_i42) + c21_i40] =
          chartInstance->c21_y[(c21_i44 + c21_i42) + c21_i40];
      }
...
static void c21_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData)
{
  const mxArray *c21_channel1Min;
  const char_T *c21_identifier;
  emlrtMsgIdentifier c21_thisId;
  real_T c21_c_y;
  SFc21_rail_ver01InstanceStruct *chartInstance;
  chartInstance = (SFc21_rail_ver01InstanceStruct *)chartInstanceVoid;
  c21_channel1Min = sf_mex_dup(c21_mxArrayInData);
  c21_identifier = c21_varName;
  c21_thisId.fIdentifier = (const char *)c21_identifier;
  c21_thisId.fParent = NULL;
  c21_thisId.bParentIsCell = false;
  c21_c_y = c21_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c21_channel1Min),
    &c21_thisId);
  sf_mex_destroy(&c21_channel1Min);
  ...
  *c21_inData)
{
  ...
  c21_mxArrayOutData = NULL;
  c21_i45 = 0;
  for (c21_i46 = 0; c21_i46 < 512; c21_i46++) {
    for (c21_i47 = 0; c21_i47 < 424; c21_i47++) {
      chartInstance->c21_c_u[c21_i47 + c21_i45] = (*(boolean_T (*)[217088])
        c21_inData)[c21_i47 + c21_i45];
    }
  ...
  c21_c_y[217088])
{
  ...
  c21_thisId.fParent = NULL;
  c21_thisId.bParentIsCell = false;
  c21_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c21_b_sliderBW), &c21_thisId,
    c21_c_y);
  sf_mex_destroy(&c21_b_sliderBW);
}
  ...
  c21_c_y[217088])
{
  ...
  sf_mex_import(c21_parentId, sf_mex_dup(c21_d_u), chartInstance->c21_bv3, 1, 11,
                0U, 1, 0U, 2, 424, 512);
  for (c21_i48 = 0; c21_i48 < 217088; c21_i48++) {
    c21_c_y[c21_i48] = chartInstance->c21_bv3[c21_i48];
  }
  ...
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData)
{
  ...
  SFc21_rail_ver01InstanceStruct *chartInstance;
  chartInstance = (SFc21_rail_ver01InstanceStruct *)chartInstanceVoid;
  c21_b_sliderBW = sf_mex_dup(c21_mxArrayInData);
  c21_identifier = c21_varName;
  c21_thisId.fIdentifier = (const char *)c21_identifier;
  c21_thisId.fParent = NULL;
  c21_thisId.bParentIsCell = false;
  ...
  for (c21_i50 = 0; c21_i50 < 512; c21_i50++) {
    for (c21_i51 = 0; c21_i51 < 424; c21_i51++) {
      (*(boolean_T (*)[217088])c21_outData)[c21_i51 + c21_i49] =
        chartInstance->c21_b_y[c21_i51 + c21_i49];
    }
  ...
  *c21_inData)
{
  ...
  for (c21_i53 = 0; c21_i53 < 3; c21_i53++) {
    c21_i54 = 0;
    for (c21_i55 = 0; c21_i55 < 512; c21_i55++) {
      for (c21_i56 = 0; c21_i56 < 424; c21_i56++) {
        chartInstance->c21_b_u[(c21_i56 + c21_i54) + c21_i52] = (*(uint8_T (*)
          [651264])c21_inData)[(c21_i56 + c21_i54) + c21_i52];
      }
  ...
  *c21_inData)
{
  ...
  c21_mxArrayOutData = NULL;
  c21_mxArrayOutData = NULL;
  for (c21_i57 = 0; c21_i57 < 6; c21_i57++) {
    c21_d_u[c21_i57] = (*(real_T (*)[6])c21_inData)[c21_i57];
  }
...
const mxArray *sf_c21_rail_ver01_get_eml_resolved_functions_info(void)
{
  ...
  *c21_identifier)
{
  ...
  c21_c_y = c21_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_rail_ver01), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_rail_ver01);
  return c21_c_y;
}
...
void sf_c21_rail_ver01_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c21_rail_ver01_get_post_codegen_info(void);
mxArray *sf_c21_rail_ver01_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c21_rail_ver01_get_post_codegen_info();
...
mxArray *sf_c21_rail_ver01_third_party_uses_info(void)
{
...
mxArray *sf_c21_rail_ver01_jit_fallback_info(void)
{
...
mxArray *sf_c21_rail_ver01_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c21_rail_ver01(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"BW\",},{M[8],M[0],T\"is_active_c21_rail_ver01\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_rail_ver01_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc21_rail_ver01InstanceStruct *chartInstance =
      (SFc21_rail_ver01InstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c21_rail_ver01(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_rail_ver01InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c21_rail_ver01((SFc21_rail_ver01InstanceStruct*)
    chartInstanceVar);
  initialize_c21_rail_ver01((SFc21_rail_ver01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_rail_ver01(void *chartInstanceVar)
{
  enable_c21_rail_ver01((SFc21_rail_ver01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_rail_ver01(void *chartInstanceVar)
{
  disable_c21_rail_ver01((SFc21_rail_ver01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_rail_ver01(void *chartInstanceVar)
{
  sf_gateway_c21_rail_ver01((SFc21_rail_ver01InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c21_rail_ver01(SimStruct* S)
{
  return get_sim_state_c21_rail_ver01((SFc21_rail_ver01InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c21_rail_ver01(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c21_rail_ver01((SFc21_rail_ver01InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c21_rail_ver01(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_rail_ver01InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_rail_ver01_optimization_info();
    }

    finalize_c21_rail_ver01((SFc21_rail_ver01InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_rail_ver01((SFc21_rail_ver01InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_rail_ver01(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c21_rail_ver01(SimStruct *S)
{
...
static void mdlRTW_c21_rail_ver01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_rail_ver01(SimStruct *S)
{
  SFc21_rail_ver01InstanceStruct *chartInstance;
  chartInstance = (SFc21_rail_ver01InstanceStruct *)utMalloc(sizeof
    (SFc21_rail_ver01InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc21_rail_ver01InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c21_rail_ver01;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c21_rail_ver01;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c21_rail_ver01;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_rail_ver01;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_rail_ver01;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c21_rail_ver01;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c21_rail_ver01;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_rail_ver01;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_rail_ver01;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_rail_ver01;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_rail_ver01;
  ...
  mdl_start_c21_rail_ver01(chartInstance);
}

void c21_rail_ver01_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_rail_ver01(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_rail_ver01(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_rail_ver01(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_rail_ver01_method_dispatcher.\n"

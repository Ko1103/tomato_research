...
static void initialize_c21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance);
static void initialize_params_c21_system_ver04(SFc21_system_ver04InstanceStruct *
  chartInstance);
static void enable_c21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance);
static void disable_c21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance);
static void c21_update_debugger_state_c21_system_ver04
  (SFc21_system_ver04InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_system_ver04
  (SFc21_system_ver04InstanceStruct *chartInstance);
static void set_sim_state_c21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance, const mxArray *c21_st);
static void finalize_c21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance);
static void sf_gateway_c21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance);
static void mdl_start_c21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance);
static void c21_chartstep_c21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance);
static void initSimStructsc21_system_ver04(SFc21_system_ver04InstanceStruct
  *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static void c21_emlrt_marshallIn(SFc21_system_ver04InstanceStruct *chartInstance,
  const mxArray *c21_c_BW, const char_T *c21_identifier, boolean_T c21_c_y
  [217088]);
static void c21_b_emlrt_marshallIn(SFc21_system_ver04InstanceStruct
...
static const mxArray *c21_d_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_c_emlrt_marshallIn(SFc21_system_ver04InstanceStruct
  *chartInstance, const mxArray *c21_d_u, const emlrtMsgIdentifier *c21_parentId);
...
static const mxArray *c21_e_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static void c21_d_emlrt_marshallIn(SFc21_system_ver04InstanceStruct
  *chartInstance, const mxArray *c21_d_u, const emlrtMsgIdentifier *c21_parentId,
...
static const mxArray *c21_f_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_e_emlrt_marshallIn(SFc21_system_ver04InstanceStruct
  *chartInstance, const mxArray *c21_d_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_f_emlrt_marshallIn(SFc21_system_ver04InstanceStruct
  *chartInstance, const mxArray *c21_b_is_active_c21_system_ver04, const char_T *
  c21_identifier);
static uint8_T c21_g_emlrt_marshallIn(SFc21_system_ver04InstanceStruct
  *chartInstance, const mxArray *c21_d_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_system_ver04InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc21_system_ver04InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc21_system_ver04(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c21_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c21_is_active_c21_system_ver04 = 0U;
}
  ...
  (SFc21_system_ver04InstanceStruct *chartInstance)
{
  ...
  c21_hoistedGlobal = chartInstance->c21_is_active_c21_system_ver04;
  c21_e_y = NULL;
  ...
  *chartInstance, const mxArray *c21_st)
{
  ...
  chartInstance->c21_is_active_c21_system_ver04 = c21_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c21_system_ver04",
       c21_d_u, 1)), "is_active_c21_system_ver04");
  sf_mex_destroy(&c21_d_u);
  c21_update_debugger_state_c21_system_ver04(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c21_sfEvent = CALL_EVENT;
  c21_chartstep_c21_system_ver04(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_system_ver04MachineNumber_,
  ...
  *c21_inData)
{
  ...
  int32_T c21_i36;
  SFc21_system_ver04InstanceStruct *chartInstance;
  chartInstance = (SFc21_system_ver04InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c21_system_ver04_get_eml_resolved_functions_info(void)
{
  ...
  c21_identifier)
{
  ...
  c21_c_y = c21_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_system_ver04), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_system_ver04);
  return c21_c_y;
}
...
void sf_c21_system_ver04_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c21_system_ver04_get_post_codegen_info(void);
mxArray *sf_c21_system_ver04_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c21_system_ver04_get_post_codegen_info();
...
mxArray *sf_c21_system_ver04_third_party_uses_info(void)
{
...
mxArray *sf_c21_system_ver04_jit_fallback_info(void)
{
...
mxArray *sf_c21_system_ver04_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c21_system_ver04(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"BW\",},{M[8],M[0],T\"is_active_c21_system_ver04\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_system_ver04_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc21_system_ver04InstanceStruct *chartInstance =
      (SFc21_system_ver04InstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_system_ver04MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_system_ver04MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _system_ver04MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c21_system_ver04(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_system_ver04InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c21_system_ver04((SFc21_system_ver04InstanceStruct*)
    chartInstanceVar);
  initialize_c21_system_ver04((SFc21_system_ver04InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c21_system_ver04(void *chartInstanceVar)
{
  enable_c21_system_ver04((SFc21_system_ver04InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_system_ver04(void *chartInstanceVar)
{
  disable_c21_system_ver04((SFc21_system_ver04InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_system_ver04(void *chartInstanceVar)
{
  sf_gateway_c21_system_ver04((SFc21_system_ver04InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c21_system_ver04(SimStruct* S)
{
  return get_sim_state_c21_system_ver04((SFc21_system_ver04InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c21_system_ver04(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c21_system_ver04((SFc21_system_ver04InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c21_system_ver04(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_system_ver04InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_system_ver04_optimization_info();
    }

    finalize_c21_system_ver04((SFc21_system_ver04InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc21_system_ver04((SFc21_system_ver04InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_system_ver04(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c21_system_ver04(SimStruct *S)
{
  /* Set overwritable ports for inplace optimization */
  ssSetStatesModifiedOnlyInUpdate(S, 1);
  ssMdlUpdateIsEmpty(S, 1);
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_system_ver04_optimization_info
...
static void mdlRTW_c21_system_ver04(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_system_ver04(SimStruct *S)
{
  SFc21_system_ver04InstanceStruct *chartInstance;
  chartInstance = (SFc21_system_ver04InstanceStruct *)utMalloc(sizeof
    (SFc21_system_ver04InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc21_system_ver04InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c21_system_ver04;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_system_ver04;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c21_system_ver04;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_system_ver04;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_system_ver04;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_system_ver04;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_system_ver04;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_system_ver04;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_system_ver04;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_system_ver04;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_system_ver04;
  ...
  mdl_start_c21_system_ver04(chartInstance);
}

void c21_system_ver04_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_system_ver04(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_system_ver04(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_system_ver04(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_system_ver04_method_dispatcher.\n"

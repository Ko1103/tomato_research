...
static void initialize_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void initialize_params_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void enable_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void disable_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void set_sim_state_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance, const
   mxArray *c12_st);
static void finalize_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void sf_gateway_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void mdl_start_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void c12_chartstep_c12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
static void initSimStructsc12_rail_ver01_NoJobHikariSensor
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance);
...
static void c12_emlrt_marshallIn
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance, const
   mxArray *c12_c_BW, const char_T *c12_identifier, boolean_T c12_c_y[217088]);
static void c12_b_emlrt_marshallIn
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance, const
   mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId, boolean_T c12_c_y
   [217088]);
...
static real_T c12_c_emlrt_marshallIn
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance, const
   mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId);
...
static void c12_d_emlrt_marshallIn
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance, const
   mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_c_y
   [651264]);
...
static uint8_T c12_f_emlrt_marshallIn
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance, const
   mxArray *c12_b_is_active_c12_rail_ver01_NoJobHikariSensor, const char_T
   *c12_identifier);
  ...
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc12_rail_ver01_NoJobHikariSensor(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c12_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c12_is_active_c12_rail_ver01_NoJobHikariSensor = 0U;
}
  ...
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance)
{
  ...
  c12_hoistedGlobal =
    chartInstance->c12_is_active_c12_rail_ver01_NoJobHikariSensor;
  c12_e_y = NULL;
   ...
   mxArray *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_rail_ver01_NoJobHikariSensor =
    ...
    "is_active_c12_rail_ver01_NoJobHikariSensor", c12_d_u, 1)),
    "is_active_c12_rail_ver01_NoJobHikariSensor");
  sf_mex_destroy(&c12_d_u);
  c12_update_debugger_state_c12_rail_ver01_NoJobHikariSensor(chartInstance);
  ...
  (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_sfEvent = CALL_EVENT;
  c12_chartstep_c12_rail_ver01_NoJobHikariSensor(chartInstance);
  ...
  *c12_inData)
{
  ...
  int32_T c12_i36;
  SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance;
  chartInstance = (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c12_rail_ver01_NoJobHikariSensor_get_eml_resolved_functions_info(void)
{
   ...
   *c12_identifier)
{
  ...
  c12_c_y = c12_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_rail_ver01_NoJobHikariSensor), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_rail_ver01_NoJobHikariSensor);
  return c12_c_y;
}
...
void sf_c12_rail_ver01_NoJobHikariSensor_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c12_rail_ver01_NoJobHikariSensor_get_post_codegen_info(void);
mxArray *sf_c12_rail_ver01_NoJobHikariSensor_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c12_rail_ver01_NoJobHikariSensor_get_post_codegen_info();
...
mxArray *sf_c12_rail_ver01_NoJobHikariSensor_third_party_uses_info(void)
{
...
mxArray *sf_c12_rail_ver01_NoJobHikariSensor_jit_fallback_info(void)
{
...
mxArray *sf_c12_rail_ver01_NoJobHikariSensor_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_rail_ver01_NoJobHikariSensor
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"BW\",},{M[8],M[0],T\"is_active_c12_rail_ver01_NoJobHikariSensor\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_rail_ver01_NoJobHikariSensor_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance =
      (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *)
...
static void sf_opaque_initialize_c12_rail_ver01_NoJobHikariSensor(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_rail_ver01_NoJobHikariSensor
    ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*) chartInstanceVar);
  initialize_c12_rail_ver01_NoJobHikariSensor
    ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_rail_ver01_NoJobHikariSensor(void
  *chartInstanceVar)
{
  enable_c12_rail_ver01_NoJobHikariSensor
    ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_rail_ver01_NoJobHikariSensor(void
  *chartInstanceVar)
{
  disable_c12_rail_ver01_NoJobHikariSensor
    ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_rail_ver01_NoJobHikariSensor(void
  *chartInstanceVar)
{
  sf_gateway_c12_rail_ver01_NoJobHikariSensor
    ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_rail_ver01_NoJobHikariSensor
  (SimStruct* S)
{
  return get_sim_state_c12_rail_ver01_NoJobHikariSensor
    ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *)
     sf_get_chart_instance_ptr(S));    /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_rail_ver01_NoJobHikariSensor(SimStruct*
  S, const mxArray *st)
{
  set_sim_state_c12_rail_ver01_NoJobHikariSensor
    ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*)
     sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c12_rail_ver01_NoJobHikariSensor(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c12_rail_ver01_NoJobHikariSensor
      ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_rail_ver01_NoJobHikariSensor
    ((SFc12_rail_ver01_NoJobHikariSensorInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_rail_ver01_NoJobHikariSensor(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_rail_ver01_NoJobHikariSensor(SimStruct *S)
{
...
static void mdlRTW_c12_rail_ver01_NoJobHikariSensor(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_rail_ver01_NoJobHikariSensor(SimStruct *S)
{
  SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *chartInstance;
  chartInstance = (SFc12_rail_ver01_NoJobHikariSensorInstanceStruct *)utMalloc
    (sizeof(SFc12_rail_ver01_NoJobHikariSensorInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_rail_ver01_NoJobHikariSensor;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_rail_ver01_NoJobHikariSensor;
  ...
  mdl_start_c12_rail_ver01_NoJobHikariSensor(chartInstance);
}

void c12_rail_ver01_NoJobHikariSensor_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_rail_ver01_NoJobHikariSensor(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_rail_ver01_NoJobHikariSensor(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_rail_ver01_NoJobHikariSensor(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_rail_ver01_NoJobHikariSensor_method_dispatcher.\n"

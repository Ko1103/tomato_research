...
static void initialize_c12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void initialize_params_c12_system_ver01(SFc12_system_ver01InstanceStruct *
  chartInstance);
static void enable_c12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void disable_c12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void c12_update_debugger_state_c12_system_ver01
  (SFc12_system_ver01InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_system_ver01
  (SFc12_system_ver01InstanceStruct *chartInstance);
static void set_sim_state_c12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance, const mxArray *c12_st);
static void finalize_c12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void sf_gateway_c12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void mdl_start_c12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void c12_chartstep_c12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void initSimStructsc12_system_ver01(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_system_ver01InstanceStruct *chartInstance,
  const mxArray *c12_c_BW, const char_T *c12_identifier, boolean_T c12_c_y
  [217088]);
static void c12_b_emlrt_marshallIn(SFc12_system_ver01InstanceStruct
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_c_emlrt_marshallIn(SFc12_system_ver01InstanceStruct
  *chartInstance, const mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_d_emlrt_marshallIn(SFc12_system_ver01InstanceStruct
  *chartInstance, const mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId,
...
static const mxArray *c12_f_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_e_emlrt_marshallIn(SFc12_system_ver01InstanceStruct
  *chartInstance, const mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_f_emlrt_marshallIn(SFc12_system_ver01InstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_system_ver01, const char_T *
  c12_identifier);
static uint8_T c12_g_emlrt_marshallIn(SFc12_system_ver01InstanceStruct
  *chartInstance, const mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_system_ver01InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc12_system_ver01InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc12_system_ver01(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c12_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c12_is_active_c12_system_ver01 = 0U;
}
  ...
  (SFc12_system_ver01InstanceStruct *chartInstance)
{
  ...
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_system_ver01;
  c12_e_y = NULL;
  ...
  *chartInstance, const mxArray *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_system_ver01 = c12_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c12_system_ver01",
       c12_d_u, 1)), "is_active_c12_system_ver01");
  sf_mex_destroy(&c12_d_u);
  c12_update_debugger_state_c12_system_ver01(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_sfEvent = CALL_EVENT;
  c12_chartstep_c12_system_ver01(chartInstance);
  ...
  *c12_inData)
{
  ...
  int32_T c12_i36;
  SFc12_system_ver01InstanceStruct *chartInstance;
  chartInstance = (SFc12_system_ver01InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_system_ver01_get_eml_resolved_functions_info(void)
{
  ...
  c12_identifier)
{
  ...
  c12_c_y = c12_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_system_ver01), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_system_ver01);
  return c12_c_y;
}
...
void sf_c12_system_ver01_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c12_system_ver01_get_post_codegen_info(void);
mxArray *sf_c12_system_ver01_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c12_system_ver01_get_post_codegen_info();
...
mxArray *sf_c12_system_ver01_third_party_uses_info(void)
{
...
mxArray *sf_c12_system_ver01_jit_fallback_info(void)
{
...
mxArray *sf_c12_system_ver01_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_system_ver01(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"BW\",},{M[8],M[0],T\"is_active_c12_system_ver01\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_system_ver01_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc12_system_ver01InstanceStruct *chartInstance =
      (SFc12_system_ver01InstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c12_system_ver01(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_system_ver01InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_system_ver01((SFc12_system_ver01InstanceStruct*)
    chartInstanceVar);
  initialize_c12_system_ver01((SFc12_system_ver01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c12_system_ver01(void *chartInstanceVar)
{
  enable_c12_system_ver01((SFc12_system_ver01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_system_ver01(void *chartInstanceVar)
{
  disable_c12_system_ver01((SFc12_system_ver01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_system_ver01(void *chartInstanceVar)
{
  sf_gateway_c12_system_ver01((SFc12_system_ver01InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_system_ver01(SimStruct* S)
{
  return get_sim_state_c12_system_ver01((SFc12_system_ver01InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_system_ver01(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c12_system_ver01((SFc12_system_ver01InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c12_system_ver01(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_system_ver01InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_system_ver01_optimization_info();
    }

    finalize_c12_system_ver01((SFc12_system_ver01InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc12_system_ver01((SFc12_system_ver01InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_system_ver01(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_system_ver01(SimStruct *S)
{
...
static void mdlRTW_c12_system_ver01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_system_ver01(SimStruct *S)
{
  SFc12_system_ver01InstanceStruct *chartInstance;
  chartInstance = (SFc12_system_ver01InstanceStruct *)utMalloc(sizeof
    (SFc12_system_ver01InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc12_system_ver01InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_system_ver01;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_system_ver01;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_system_ver01;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_system_ver01;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_system_ver01;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_system_ver01;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_system_ver01;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_system_ver01;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_system_ver01;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_system_ver01;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_system_ver01;
  ...
  mdl_start_c12_system_ver01(chartInstance);
}

void c12_system_ver01_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_system_ver01(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_system_ver01(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_system_ver01(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_system_ver01_method_dispatcher.\n"

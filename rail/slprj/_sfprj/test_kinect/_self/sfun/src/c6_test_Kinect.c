...
static void initialize_c6_test_Kinect(SFc6_test_KinectInstanceStruct
  *chartInstance);
static void initialize_params_c6_test_Kinect(SFc6_test_KinectInstanceStruct
  *chartInstance);
static void enable_c6_test_Kinect(SFc6_test_KinectInstanceStruct *chartInstance);
static void disable_c6_test_Kinect(SFc6_test_KinectInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_test_Kinect
  (SFc6_test_KinectInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_test_Kinect
  (SFc6_test_KinectInstanceStruct *chartInstance);
static void set_sim_state_c6_test_Kinect(SFc6_test_KinectInstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_test_Kinect(SFc6_test_KinectInstanceStruct
  *chartInstance);
static void sf_gateway_c6_test_Kinect(SFc6_test_KinectInstanceStruct
  *chartInstance);
static void mdl_start_c6_test_Kinect(SFc6_test_KinectInstanceStruct
  *chartInstance);
static void c6_chartstep_c6_test_Kinect(SFc6_test_KinectInstanceStruct
  *chartInstance);
static void initSimStructsc6_test_Kinect(SFc6_test_KinectInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_test_KinectInstanceStruct *chartInstance,
  const mxArray *c6_c_BW, const char_T *c6_identifier, boolean_T c6_c_y[217088]);
static void c6_b_emlrt_marshallIn(SFc6_test_KinectInstanceStruct *chartInstance,
  const mxArray *c6_d_u, const emlrtMsgIdentifier *c6_parentId, boolean_T
  c6_c_y[217088]);
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_test_KinectInstanceStruct
...
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_d_emlrt_marshallIn(SFc6_test_KinectInstanceStruct *chartInstance,
  const mxArray *c6_d_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_c_y
  [651264]);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_f_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_e_emlrt_marshallIn(SFc6_test_KinectInstanceStruct
  *chartInstance, const mxArray *c6_d_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_f_emlrt_marshallIn(SFc6_test_KinectInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_test_Kinect, const char_T
  *c6_identifier);
static uint8_T c6_g_emlrt_marshallIn(SFc6_test_KinectInstanceStruct
  *chartInstance, const mxArray *c6_d_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_test_KinectInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc6_test_KinectInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc6_test_Kinect(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c6_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c6_is_active_c6_test_Kinect = 0U;
}
  ...
  (SFc6_test_KinectInstanceStruct *chartInstance)
{
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_test_Kinect;
  c6_e_y = NULL;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_test_Kinect = c6_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c6_test_Kinect", c6_d_u,
       1)), "is_active_c6_test_Kinect");
  sf_mex_destroy(&c6_d_u);
  c6_update_debugger_state_c6_test_Kinect(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_test_Kinect(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  int32_T c6_i36;
  SFc6_test_KinectInstanceStruct *chartInstance;
  chartInstance = (SFc6_test_KinectInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_test_Kinect_get_eml_resolved_functions_info(void)
{
  ...
  *c6_identifier)
{
  ...
  c6_c_y = c6_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_test_Kinect), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_test_Kinect);
  return c6_c_y;
}
...
void sf_c6_test_Kinect_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c6_test_Kinect_get_post_codegen_info(void);
mxArray *sf_c6_test_Kinect_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_test_Kinect_get_post_codegen_info();
...
mxArray *sf_c6_test_Kinect_third_party_uses_info(void)
{
...
mxArray *sf_c6_test_Kinect_jit_fallback_info(void)
{
...
mxArray *sf_c6_test_Kinect_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_test_Kinect(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"BW\",},{M[8],M[0],T\"is_active_c6_test_Kinect\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_test_Kinect_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_test_KinectInstanceStruct *chartInstance =
      (SFc6_test_KinectInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c6_test_Kinect(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_test_KinectInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c6_test_Kinect((SFc6_test_KinectInstanceStruct*)
    chartInstanceVar);
  initialize_c6_test_Kinect((SFc6_test_KinectInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_test_Kinect(void *chartInstanceVar)
{
  enable_c6_test_Kinect((SFc6_test_KinectInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_test_Kinect(void *chartInstanceVar)
{
  disable_c6_test_Kinect((SFc6_test_KinectInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_test_Kinect(void *chartInstanceVar)
{
  sf_gateway_c6_test_Kinect((SFc6_test_KinectInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_test_Kinect(SimStruct* S)
{
  return get_sim_state_c6_test_Kinect((SFc6_test_KinectInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_test_Kinect(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c6_test_Kinect((SFc6_test_KinectInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c6_test_Kinect(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_test_KinectInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_test_Kinect_optimization_info();
    }

    finalize_c6_test_Kinect((SFc6_test_KinectInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_test_Kinect((SFc6_test_KinectInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_test_Kinect(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_test_Kinect(SimStruct *S)
{
...
static void mdlRTW_c6_test_Kinect(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_test_Kinect(SimStruct *S)
{
  SFc6_test_KinectInstanceStruct *chartInstance;
  chartInstance = (SFc6_test_KinectInstanceStruct *)utMalloc(sizeof
    (SFc6_test_KinectInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc6_test_KinectInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_test_Kinect;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_test_Kinect;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_test_Kinect;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_test_Kinect;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_test_Kinect;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_test_Kinect;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_test_Kinect;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_test_Kinect;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_test_Kinect;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_test_Kinect;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_test_Kinect;
  ...
  mdl_start_c6_test_Kinect(chartInstance);
}

void c6_test_Kinect_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_test_Kinect(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_test_Kinect(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_test_Kinect(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_test_Kinect_method_dispatcher.\n"

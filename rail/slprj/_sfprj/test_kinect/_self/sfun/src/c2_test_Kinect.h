#ifndef __c2_test_Kinect_h__
#define __c2_test_Kinect_h__
...
#ifndef typedef_SFc2_test_KinectInstanceStruct
#define typedef_SFc2_test_KinectInstanceStruct
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_test_Kinect;
  real_T c2_I[651264];
...
#endif                                 /*typedef_SFc2_test_KinectInstanceStruct*/
...
extern const mxArray *sf_c2_test_Kinect_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c2_test_Kinect_get_check_sum(mxArray *plhs[]);
extern void c2_test_Kinect_method_dispatcher(SimStruct *S, int_T method, void
  *data);

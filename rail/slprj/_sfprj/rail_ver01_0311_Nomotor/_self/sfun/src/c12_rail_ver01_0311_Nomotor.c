...
#include "c12_rail_ver01_0311_Nomotor.h"
...
static void initialize_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void initialize_params_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void enable_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void disable_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void set_sim_state_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance, const mxArray
   *c12_st);
static void finalize_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void sf_gateway_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void mdl_start_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void c12_chartstep_c12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void initSimStructsc12_rail_ver01_0311_Nomotor
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_rail_ver01_0311_NomotorInstanceStruct
  *chartInstance, const mxArray *c12_c_BW, const char_T *c12_identifier,
  boolean_T c12_c_y[217088]);
static void c12_b_emlrt_marshallIn(SFc12_rail_ver01_0311_NomotorInstanceStruct
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_c_emlrt_marshallIn(SFc12_rail_ver01_0311_NomotorInstanceStruct
  *chartInstance, const mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_d_emlrt_marshallIn(SFc12_rail_ver01_0311_NomotorInstanceStruct
  *chartInstance, const mxArray *c12_d_u, const emlrtMsgIdentifier *c12_parentId,
...
static int32_T c12_e_emlrt_marshallIn
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance, const mxArray
   *c12_d_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_f_emlrt_marshallIn
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance, const mxArray
   *c12_b_is_active_c12_rail_ver01_0311_Nomotor, const char_T *c12_identifier);
static uint8_T c12_g_emlrt_marshallIn
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance, const mxArray
   *c12_d_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_rail_ver01_0311_NomotorInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc12_rail_ver01_0311_NomotorInstanceStruct
  *chartInstance);
  ...
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc12_rail_ver01_0311_Nomotor(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c12_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c12_is_active_c12_rail_ver01_0311_Nomotor = 0U;
}
  ...
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance)
{
  ...
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_rail_ver01_0311_Nomotor;
  c12_e_y = NULL;
   ...
   *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_rail_ver01_0311_Nomotor =
    c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(
    "is_active_c12_rail_ver01_0311_Nomotor", c12_d_u, 1)),
    "is_active_c12_rail_ver01_0311_Nomotor");
  sf_mex_destroy(&c12_d_u);
  c12_update_debugger_state_c12_rail_ver01_0311_Nomotor(chartInstance);
  ...
  (SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_sfEvent = CALL_EVENT;
  c12_chartstep_c12_rail_ver01_0311_Nomotor(chartInstance);
  ...
  *c12_inData)
{
  ...
  int32_T c12_i36;
  SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance;
  chartInstance = (SFc12_rail_ver01_0311_NomotorInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c12_rail_ver01_0311_Nomotor_get_eml_resolved_functions_info
  (void)
{
   ...
   *c12_b_is_active_c12_rail_ver01_0311_Nomotor, const char_T *c12_identifier)
{
  ...
  c12_c_y = c12_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_rail_ver01_0311_Nomotor), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_rail_ver01_0311_Nomotor);
  return c12_c_y;
}
...
void sf_c12_rail_ver01_0311_Nomotor_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c12_rail_ver01_0311_Nomotor_get_post_codegen_info(void);
mxArray *sf_c12_rail_ver01_0311_Nomotor_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c12_rail_ver01_0311_Nomotor_get_post_codegen_info();
...
mxArray *sf_c12_rail_ver01_0311_Nomotor_third_party_uses_info(void)
{
...
mxArray *sf_c12_rail_ver01_0311_Nomotor_jit_fallback_info(void)
{
...
mxArray *sf_c12_rail_ver01_0311_Nomotor_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_rail_ver01_0311_Nomotor(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"BW\",},{M[8],M[0],T\"is_active_c12_rail_ver01_0311_Nomotor\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_rail_ver01_0311_Nomotor_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance =
      (SFc12_rail_ver01_0311_NomotorInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c12_rail_ver01_0311_Nomotor(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_rail_ver01_0311_NomotorInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_rail_ver01_0311_Nomotor
    ((SFc12_rail_ver01_0311_NomotorInstanceStruct*) chartInstanceVar);
  initialize_c12_rail_ver01_0311_Nomotor
    ((SFc12_rail_ver01_0311_NomotorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_rail_ver01_0311_Nomotor(void *chartInstanceVar)
{
  enable_c12_rail_ver01_0311_Nomotor
    ((SFc12_rail_ver01_0311_NomotorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_rail_ver01_0311_Nomotor(void *chartInstanceVar)
{
  disable_c12_rail_ver01_0311_Nomotor
    ((SFc12_rail_ver01_0311_NomotorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_rail_ver01_0311_Nomotor(void *chartInstanceVar)
{
  sf_gateway_c12_rail_ver01_0311_Nomotor
    ((SFc12_rail_ver01_0311_NomotorInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_rail_ver01_0311_Nomotor
  (SimStruct* S)
{
  return get_sim_state_c12_rail_ver01_0311_Nomotor
    ((SFc12_rail_ver01_0311_NomotorInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_rail_ver01_0311_Nomotor(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c12_rail_ver01_0311_Nomotor
    ((SFc12_rail_ver01_0311_NomotorInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c12_rail_ver01_0311_Nomotor(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_rail_ver01_0311_NomotorInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c12_rail_ver01_0311_Nomotor
      ((SFc12_rail_ver01_0311_NomotorInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_rail_ver01_0311_Nomotor
    ((SFc12_rail_ver01_0311_NomotorInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_rail_ver01_0311_Nomotor(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_rail_ver01_0311_Nomotor(SimStruct *S)
{
...
static void mdlRTW_c12_rail_ver01_0311_Nomotor(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_rail_ver01_0311_Nomotor(SimStruct *S)
{
  SFc12_rail_ver01_0311_NomotorInstanceStruct *chartInstance;
  chartInstance = (SFc12_rail_ver01_0311_NomotorInstanceStruct *)utMalloc(sizeof
    (SFc12_rail_ver01_0311_NomotorInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc12_rail_ver01_0311_NomotorInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_rail_ver01_0311_Nomotor;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_rail_ver01_0311_Nomotor;
  ...
  mdl_start_c12_rail_ver01_0311_Nomotor(chartInstance);
}

void c12_rail_ver01_0311_Nomotor_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_rail_ver01_0311_Nomotor(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_rail_ver01_0311_Nomotor(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_rail_ver01_0311_Nomotor(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_rail_ver01_0311_Nomotor_method_dispatcher.\n"

...
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_b_emlrt_marshallIn(SFc6_test_kinect_ver2InstanceStruct
  *chartInstance, const mxArray *c6_d_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_c_emlrt_marshallIn(SFc6_test_kinect_ver2InstanceStruct
  *chartInstance, const mxArray *c6_b_sliderBW, const char_T *c6_identifier,
  ...
  (SFc6_test_kinect_ver2InstanceStruct *chartInstance, const mxArray *c6_st)
{
  ...
  c6_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_d_u, 0)),
  ...
  chartInstance->c6_is_active_c6_test_kinect_ver2 = c6_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_d_u, 1)),
     "is_active_c6_test_kinect_ver2");
  ...
  *chartInstance)
{
  ...
  for (c6_i1 = 0; c6_i1 < 6; c6_i1++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c6_value)[c6_i1], 1U);
  }

  for (c6_i2 = 0; c6_i2 < 651264; c6_i2++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c6_b_RGB)[c6_i2], 0U);
  }
  ...
  for (c6_i3 = 0; c6_i3 < 217088; c6_i3++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c6_b_BW)[c6_i3], 2U);
  }
}
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_channel1Min, 1U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_channel1Max, 2U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_channel2Min, 3U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_channel2Max, 4U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_channel3Min, 5U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_channel3Max, 6U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 9U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(chartInstance->c6_RGB, 10U, c6_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_b_value, 11U, c6_e_sf_marshallOut);
  ...
  rgb2hsv_tbb_uint8(chartInstance->c6_X, 217088.0, chartInstance->c6_I, true);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  for (c6_i35 = 0; c6_i35 < 3; c6_i35++) {
    c6_i36 = 0;
    for (c6_i37 = 0; c6_i37 < 512; c6_i37++) {
      for (c6_i38 = 0; c6_i38 < 424; c6_i38++) {
        chartInstance->c6_u[(c6_i38 + c6_i36) + c6_i34] = (*(real_T (*)[651264])
          c6_inData)[(c6_i38 + c6_i36) + c6_i34];
      }
  ...
  real_T c6_c_y[651264])
{
  ...
  sf_mex_import(c6_parentId, sf_mex_dup(c6_d_u), chartInstance->c6_dv0, 1, 0, 0U,
                1, 0U, 3, 424, 512, 3);
  for (c6_i39 = 0; c6_i39 < 651264; c6_i39++) {
    c6_c_y[c6_i39] = chartInstance->c6_dv0[c6_i39];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  c6_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_I), &c6_thisId,
                      chartInstance->c6_y);
  sf_mex_destroy(&c6_b_I);
  c6_i40 = 0;
  for (c6_i41 = 0; c6_i41 < 3; c6_i41++) {
    c6_i42 = 0;
    for (c6_i43 = 0; c6_i43 < 512; c6_i43++) {
      for (c6_i44 = 0; c6_i44 < 424; c6_i44++) {
        (*(real_T (*)[651264])c6_outData)[(c6_i44 + c6_i42) + c6_i40] =
          chartInstance->c6_y[(c6_i44 + c6_i42) + c6_i40];
      }
...
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  const mxArray *c6_channel1Min;
  const char_T *c6_identifier;
  emlrtMsgIdentifier c6_thisId;
  real_T c6_c_y;
  SFc6_test_kinect_ver2InstanceStruct *chartInstance;
  chartInstance = (SFc6_test_kinect_ver2InstanceStruct *)chartInstanceVoid;
  c6_channel1Min = sf_mex_dup(c6_mxArrayInData);
  c6_identifier = c6_varName;
  c6_thisId.fIdentifier = (const char *)c6_identifier;
  c6_thisId.fParent = NULL;
  c6_thisId.bParentIsCell = false;
  c6_c_y = c6_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_channel1Min),
    &c6_thisId);
  sf_mex_destroy(&c6_channel1Min);
  ...
  *c6_inData)
{
  ...
  c6_mxArrayOutData = NULL;
  c6_i45 = 0;
  for (c6_i46 = 0; c6_i46 < 512; c6_i46++) {
    for (c6_i47 = 0; c6_i47 < 424; c6_i47++) {
      chartInstance->c6_c_u[c6_i47 + c6_i45] = (*(boolean_T (*)[217088])
        c6_inData)[c6_i47 + c6_i45];
    }
  ...
  boolean_T c6_c_y[217088])
{
  ...
  c6_thisId.fParent = NULL;
  c6_thisId.bParentIsCell = false;
  c6_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_sliderBW), &c6_thisId,
                        c6_c_y);
  sf_mex_destroy(&c6_b_sliderBW);
}
  ...
  boolean_T c6_c_y[217088])
{
  ...
  sf_mex_import(c6_parentId, sf_mex_dup(c6_d_u), chartInstance->c6_bv3, 1, 11,
                0U, 1, 0U, 2, 424, 512);
  for (c6_i48 = 0; c6_i48 < 217088; c6_i48++) {
    c6_c_y[c6_i48] = chartInstance->c6_bv3[c6_i48];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  SFc6_test_kinect_ver2InstanceStruct *chartInstance;
  chartInstance = (SFc6_test_kinect_ver2InstanceStruct *)chartInstanceVoid;
  c6_b_sliderBW = sf_mex_dup(c6_mxArrayInData);
  c6_identifier = c6_varName;
  c6_thisId.fIdentifier = (const char *)c6_identifier;
  c6_thisId.fParent = NULL;
  c6_thisId.bParentIsCell = false;
  ...
  for (c6_i50 = 0; c6_i50 < 512; c6_i50++) {
    for (c6_i51 = 0; c6_i51 < 424; c6_i51++) {
      (*(boolean_T (*)[217088])c6_outData)[c6_i51 + c6_i49] =
        chartInstance->c6_b_y[c6_i51 + c6_i49];
    }
  ...
  *c6_inData)
{
  ...
  for (c6_i53 = 0; c6_i53 < 3; c6_i53++) {
    c6_i54 = 0;
    for (c6_i55 = 0; c6_i55 < 512; c6_i55++) {
      for (c6_i56 = 0; c6_i56 < 424; c6_i56++) {
        chartInstance->c6_b_u[(c6_i56 + c6_i54) + c6_i52] = (*(uint8_T (*)
          [651264])c6_inData)[(c6_i56 + c6_i54) + c6_i52];
      }
  ...
  *c6_inData)
{
  ...
  for (c6_i57 = 0; c6_i57 < 6; c6_i57++) {
    c6_d_u[c6_i57] = (*(real_T (*)[6])c6_inData)[c6_i57];
  }

...
MODEL     = test_kinect_ver2
TARGET      = sfun
MODULE_SRCS   = c2_test_kinect_ver2.c c6_test_kinect_ver2.c
MODEL_SRC  = test_kinect_ver2_sfun.c
MODEL_REG = test_kinect_ver2_sfun_registry.c
MAKEFILE    = test_kinect_ver2_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Tomato\Google ƒhƒ‰ƒCƒu\2017\1208-10_competition\test\kinect\slprj\_sfprj\test_kinect_ver2\_self\sfun\src" 
...
OBJLIST_FILE = test_kinect_ver2_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
